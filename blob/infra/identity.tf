...
# --- AI Search → Storage (write knowledge store projections, indexer cache) ---
...
# --- Deployer → AI Search (create/update indexes, skillsets, datasources, indexers via deploy_search.py) ---
...
# --- Deployer → AI Search (write index data for testing) ---
...
# --- Foundry Project Identity → Storage Blob Data Reader (access documents) ---
