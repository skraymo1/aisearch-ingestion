...
# ------------------------------------------------------------------------------
output "sharepoint_app_client_id" {
  value       = azuread_application.sharepoint_connector.client_id
  description = "SharePoint connector app registration client ID"
}

output "sharepoint_app_display_name" {
  value       = azuread_application.sharepoint_connector.display_name
  description = "SharePoint connector app registration display name"
}

output "sharepoint_app_object_id" {
  value       = azuread_application.sharepoint_connector.id
  description = "SharePoint connector app registration object ID"
}
